...
class exams1 extends Assignment implements Lab,Quiz{
	int mid_ms;
	int end_ms;
	int q1;
	int q2;
	...
	exams1(int mid_ms,int end_ms,int q1,int q2,int q3,int ms1,int ms2,int l1,int l2,int l3,int l4){
		super(ms1,ms2);
		this.mid_ms=mid_ms;
		this.end_ms=end_ms;
		this.q1=q1;
...
public class Eo101 {
	public static void main(String[] args) {
		...
		int l4=sc.nextInt();
		exams1 obj1=new exams1(a,b,q1,q2,q3,a1,a2,l1,l2,l3,l4);
		int s=0;
		s+=obj1.best(q1,q2,q3)+obj1.avg(l1,l2,l3,l4)+obj1.total(a,b,a1,a2);
		System.out.println("The Final Marks of Electronics are "+s);
		sc.close();
	}
